...
_OBJ = collisions.o draw.o eventthread.o game.o loading.o main.o mathematics.o menu.o stringprocessing.o structures/collstructures.o structures/fastreadset.o structures/gameobjects.o structures/gameshareddata.o structures/level.o structures/RBtree.o structures/zone.o Tests/AllTests.o Tests/collisionsSuite.o Tests/CuTest.o Tests/fastreadsetSuite.o Tests/heapSuite.o Tests/levelSuite.o Tests/mathematicsSuite.o Tests/RBtreeSuite.o Tests/stringprocessing.o
